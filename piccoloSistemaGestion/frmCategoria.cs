...
namespace piccoloSistemaGestion
{
    public partial class frmCategoria: Form
    {
        ...
        private void dgvData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvData.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtDescripcion.Text = dgvData.Rows[indice].Cells["Documento"].Value.ToString();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Desea eliminar esta categoría?", "Confirmar eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Categoria obj = new Categoria()
                    {
